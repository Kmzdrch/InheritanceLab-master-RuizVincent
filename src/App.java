public class App {
    public static void main(String[] args) throws Exception {
        ...
        Wizard Cedrick = new Wizard("Cedrick",1,100,200);
        Warlock Vishnu = new Warlock("Vishnu",1,100,200);
        
        Cedrick.displayName(Cedrick);
        Vishnu.displayName(Vishnu);
        System.out.println("Welcome to Summoners Rift");
        
        Cedrick.ThunderBreath(Vishnu);
        Vishnu.NeckSlash(Cedrick);
        Cedrick.FireBreath(Vishnu);
        Vishnu.NeckDash(Cedrick);
        Cedrick.cure();
        Vishnu.NeckExecution(Cedrick);
        Cedrick.UnstopabbleBreath(Vishnu);
        Cedrick.levelUp(Cedrick);
